...
## Modèle économique
**Open-source, licence MIT**, gratuit. L'auteur accepte des **sponsorships** (GitHub Sponsors) ; pas de tier commercial annoncé. Très populaire : **~93k★**, présenté comme le **plugin n°1 de l'écosystème Claude Code**.
