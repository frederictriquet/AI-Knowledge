...
- ⚠️ **Hype ≠ valeur prouvée** : **220,8k★ / 33,8k forks** (confirmés API GitHub) atteints en ~5 mois — niveau anormalement élevé vs les peers (Superpowers ~93k, BMAD ~49k) ; signal de viralité/promotion autant que d'usage. Aucun benchmark externe.
