...
- Positionnement « narratif » concurrent de [[liza]] : Paperclip = « zero-human companies » (opérations business) vs Liza = « sessions d'agents zero-trust » (ingénierie logicielle). Recouvrement fonctionnel direct faible mais frontale sur le récit. Voir aussi [[mindflight-orchestrator]] côté automatisation d'entreprise.
