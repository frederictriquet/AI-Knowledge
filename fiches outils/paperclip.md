...
- Sur les étoiles : le comparatif Liza cite « ~14k★ … 14k stars in days » (instantané au lancement). Le dépôt canonique `paperclipai/paperclip` affiche ≈70k★ (relevés le 2026-06-15), signe d'une traction très rapide. Un dépôt `agencyenterprise/paperclip-ai` existe aussi (≈3★) — probablement origine/miroir de l'éditeur (Agency Enterprise / Ry Walker).
