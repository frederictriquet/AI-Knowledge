...
> Fiche **source : Lightman et al. (OpenAI), « Let's Verify Step by Step », 2023** · [papier](../md/verify-step-by-step.md) · Pertinence 🔴 substance

> ⚠️ Fiche établie à partir de l'**abstract** (le HTML LaTeXML de ce papier est indisponible sur arXiv ; voir [md](../md/verify-step-by-step.md)).
...
## Voir aussi
- (agents IBM hors-corpus) [Process Reward Models](../../../ibm-guide-agents-ia/concepts/hors-corpus/process-reward-models.md)
...
- [papier](../md/verify-step-by-step.md)
