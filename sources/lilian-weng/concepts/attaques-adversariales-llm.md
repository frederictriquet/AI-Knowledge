...
> Fiche **source : Lilian Weng** · [post complet](../md/2023-10-25-adv-attack-llm.md) · Pertinence 🔴 substance
...
IBM décrit jailbreak et injection de prompt comme catégories de menace ; Weng fournit la profondeur mécaniste absente (gradient, GCG, Gumbel-Softmax, transférabilité, perplexité comme filtre défensif).
...
## Voir aussi
- (base prompting) [Jailbreak](../../../ibm-guide-prompt-engineering/concepts/jailbreak.md) · [Injection de prompt](../../../ibm-guide-prompt-engineering/concepts/prompt-injection.md)
- (base agents) [Sécurité agentique](../../../ibm-guide-agents-ia/concepts/securite-agentique.md)
- [post complet](../md/2023-10-25-adv-attack-llm.md)
