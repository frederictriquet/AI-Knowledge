...
> Fiche **source : Johann Rehberger (Embrace The Red)** · [post](../md/m365-copilot-exfil.md) · Pertinence 🔴 substance
...
IBM reste générique sur la sécurité ; ici une kill chain réelle, divulguée de façon responsable, montrant comment trois primitives anodines se composent en vol de données d'entreprise.
...
- [post complet](../md/m365-copilot-exfil.md)
