...
> Fiche **source : Simon Willison** · [post complet](../md/dual-llm-pattern.md) · Pertinence 🔴 substance
...
## Voir aussi
- (agents IBM, fiche dérivée) [dual-LLM & CaMeL](../../../ibm-guide-agents-ia/concepts/hors-corpus/dual-llm-camel.md)
...
- [post complet](../md/dual-llm-pattern.md)
