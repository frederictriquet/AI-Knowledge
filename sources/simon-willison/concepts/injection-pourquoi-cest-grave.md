...
> Fiche **source : Simon Willison** · [post complet](../md/worst-that-can-happen.md) · Pertinence 🔴 substance
...
Willison est la source primaire qui a popularisé la prompt injection et ses scénarios concrets d'exfiltration ; les fiches IBM sur l'injection en sont des reformulations dérivées et synthétiques.
...
- (prompt-eng IBM) [Prévenir l'injection](../../../ibm-guide-prompt-engineering/concepts/prevent-prompt-injection.md)
- (Weng) [Attaques adversariales](../../lilian-weng/concepts/attaques-adversariales-llm.md)
- (Prompt Report) [Taxonomie du prompt hacking](../../prompt-report/concepts/prompt-hacking-taxonomie.md)
- [post complet](../md/worst-that-can-happen.md)
- (complément — *payloads exacts & PoC*) [Rehberger — AI injections basics](../../embrace-the-red/concepts/ai-injections-basics.md)
