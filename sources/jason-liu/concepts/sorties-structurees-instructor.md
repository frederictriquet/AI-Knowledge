...
> Fiche **source : Jason Liu (jxnl)** · [post](../md/instructor-home.md) · Pertinence 🟡 tradeoff
...
## Voir aussi
- (agents IBM hors-corpus) [Décodage contraint / sortie structurée](../../../ibm-guide-agents-ia/concepts/hors-corpus/constrained-decoding.md)
- (agents IBM) [Tool calling](../../../ibm-guide-agents-ia/concepts/tool-calling.md)
- (Hamel) [LLM-as-judge (bien fait)](../../hamel-husain/concepts/llm-as-judge-correct.md)
- [post complet](../md/instructor-home.md)
