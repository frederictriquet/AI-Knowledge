...
> Fiche **source : Jason Liu (jxnl)** · [post](../md/ameliorer-rag-systematiquement.md) · Pertinence 🔴 substance
...
## Voir aussi
- (agents IBM) [RAG agentique](../../../ibm-guide-agents-ia/concepts/rag-agentique.md) · [Sous-types RAG agentique](../../../ibm-guide-agents-ia/concepts/sous-types-rag-agentique.md)
- (agents IBM hors-corpus) [Reranking](../../../ibm-guide-agents-ia/concepts/hors-corpus/reranking.md)
- (Hamel) [Error analysis](../../hamel-husain/concepts/error-analysis.md) · [Eval-driven development](../../hamel-husain/concepts/eval-driven-development.md)
- [post complet](../md/ameliorer-rag-systematiquement.md)
