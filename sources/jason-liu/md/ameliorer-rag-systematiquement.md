...
> Auteur : Jason Liu (jxnl)

# Systematically Improving Your RAG

[](https://github.com/jxnl/blog/edit/main/docs/writing/posts/rag-improving-rag.md) [](https://github.com/jxnl/blog/raw/main/docs/writing/posts/rag-improving-rag.md)

# Systematically Improving Your RAG[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#systematically-improving-your-rag)

This article explains how to make Retrieval-Augmented Generation (RAG) systems better. It's based on a talk I had with [Hamel](https://hamel.dev) and builds on other articles I've written about RAG. For a comprehensive understanding of RAG fundamentals, see my guide on [what RAG is](https://jxnl.co/writing/2024/11/07/what-is-retrieval-augmented-generation/).

In [RAG is More Than Just Embeddings](https://jxnl.co/writing/2023/09/17/rag-is-more-than-embeddings/), I talk about how RAG is more than just vector embeddings. This helps you understand RAG better. I also wrote [How to Build a Terrible RAG System](https://jxnl.co/writing/2024/01/07/inverted-thinking-rag/), where I show what not to do, which can help you learn good practices.

If you want to learn about how complex RAG systems can be, check out [Levels of RAG Complexity](https://jxnl.co/writing/2024/02/28/levels-of-complexity-rag-applications/). This article breaks down RAG into smaller parts, making it easier to understand. For quick tips on making your RAG system better, read [Low Hanging Fruit in RAG](https://jxnl.co/writing/2024/05/11/low-hanging-fruit-for-rag-search/).

I also wrote about what I think will happen with RAG in the future in [Predictions for the Future of RAG](https://jxnl.co/writing/2024/06/05/predictions-for-the-future-of-rag/). This article talks about how RAG might be used to create reports in the future.

All these articles work together to give you a full guide on how to make RAG systems better. They offer useful tips for developers and companies who want to improve their systems. For additional improvement strategies, check out my [six tips for improving RAG](https://jxnl.co/writing/2024/11/04/how-to-improve-rag-applications-6-proven-strategies/) and insights on [RAG anti-patterns](https://jxnl.co/writing/2025/06/11/rag-anti-patterns-with-skylar-payne/). If you're interested in AI engineering in general, you might enjoy my talk at the [AI Engineer Summit](https://jxnl.co/writing/2023/11/02/ai-engineer-keynote-pydantic-is-all-you-need/). In this talk, I explain how tools like Pydantic can help with prompt engineering, which is useful for building RAG systems.
...
## Start with Synthetic Data[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#start-with-synthetic-data)
...
## Use Both Full-Text Search and Vector Search[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#use-both-full-text-search-and-vector-search)
...
## Implement Clear User Feedback Mechanisms[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#implement-clear-user-feedback-mechanisms)
...
## Cluster and Model Topics[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#cluster-and-model-topics)
...
- Topic clusters: Are users asking about specific topics more than others? This could indicate a need for more content in those areas or better retrieval of existing content. I explore this concept further in my post on [RAG decomposition](https://jxnl.co/writing/2024/11/18/decomposing-rag-systems-to-identify-bottlenecks/) and [topics and capabilities](https://jxnl.co/writing/2024/06/29/art-of-looking-at-rag-data/).
...
## Continuously Monitor and Experiment[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#continuously-monitor-and-experiment)
...
## Balance Latency and Performance[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#balance-latency-and-performance)
...
## Wrapping Up[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#wrapping-up)
...
## Want to learn more?[](https://jxnl.co/writing/2024/05/22/systematically-improving-your-rag/#want-to-learn-more)
...
[Free 6-Week RAG Email Course](https://dub.link/6wk-rag-email) [Full Course Breakdown](https://jxnl.co/writing/2025/01/24/systematically-improving-rag-applications/) [RAG FAQ](https://jxnl.co/writing/2024/10/26/faq-on-improving-rag-applications/)
