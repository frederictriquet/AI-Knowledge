...
## Voir aussi
- (Weng) [Cadre canonique de l'agent](../../lilian-weng/concepts/agent-architecture-canonique.md)
- (agents IBM) [Types d'orchestration](../../../ibm-guide-agents-ia/concepts/orchestration-types.md) · [ReAct](../../../ibm-guide-agents-ia/concepts/react.md)
