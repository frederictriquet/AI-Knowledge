...
> Fiche **source : Eugene Yan** · [post](../md/evals.md) · Pertinence 🔴 substance
...
- (benchmarks) [Pourquoi les benchmarks comptent](../../benchmarks/concepts/pourquoi-les-benchmarks-comptent.md)
- (Hamel) [Error analysis](../../hamel-husain/concepts/error-analysis.md)
- [post complet](../md/evals.md)
