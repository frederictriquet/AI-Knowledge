...
| 3 | NIST AI 100-2 — Adversarial ML | NIST, mars 2025 | [PDF](md/NIST.AI.100-2e2025.pdf), [texte](md/NIST.plain.txt) | [csrc.nist.gov](https://csrc.nist.gov/pubs/ai/100/2/e2025/final) |

## Fiches de synthèse

- 🔴 [OWASP Top 10 for LLM Applications](concepts/owasp-llm-top-10.md) — les 10 risques `LLM0x:2025` + volet Agentic AI.
- 🔴 [MITRE ATLAS](concepts/mitre-atlas.md) — matrice de 16 tactiques / 101 techniques / 57 études de cas adverses contre l'IA.
- 🔴 [NIST AI 100-2 : taxonomie de l'adversarial ML](concepts/nist-ai-100-2.md) — taxonomie officielle PredAI / GenAI (évasion, empoisonnement, privacy, prompt injection directe/indirecte).
