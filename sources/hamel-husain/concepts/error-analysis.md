...
> Fiche **source : Hamel Husain** · [post complet](../md/field-guide.md) · Pertinence 🔴 substance
...
Le guide IBM décrit l'évaluation de trajectoire et les taxonomies d'erreurs au niveau conceptuel, mais ne détaille quasiment pas la pratique manuelle de lecture des traces ; Hamel fournit le protocole opérationnel concret (annoter, taxonomiser, compter) qui précède toute automatisation.
...
## Voir aussi
- (agents IBM) [Évaluation de trajectoire](../../../ibm-guide-agents-ia/concepts/evaluation-trajectoire.md)
- (agents IBM) [Taxonomie d'erreurs d'appel de fonction](../../../ibm-guide-agents-ia/concepts/taxonomie-erreurs-appel-fonction.md)
