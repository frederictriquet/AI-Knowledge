...
> Fiche **source : Hamel Husain** · [post complet](../md/llm-judge.md) · Pertinence 🔴 substance
...
- (Prompt Report) [Techniques d'auto-critique](../../prompt-report/concepts/self-criticism-techniques.md)
- [error analysis](error-analysis.md)
- [post complet](../md/llm-judge.md)
- (complémentaire — *choisir/évaluer* un juge) [Eugene Yan — LLM-evaluators](../../eugene-yan/concepts/llm-evaluators.md)
