...
> Fiche **source : DSPy (Khattab et al., 2023)** · [papier](../md/dspy-paper.md) · Pertinence 🔴 substance
...
## Voir aussi
- (prompt-eng IBM) [DSPy](../../../ibm-guide-prompt-engineering/concepts/dspy.md) · [Optimisation des prompts](../../../ibm-guide-prompt-engineering/concepts/prompt-optimization.md)
- [DSPy : compilation & bootstrapping](dspy-compilation-bootstrap.md)
- [papier complet](../md/dspy-paper.md)
