...
> Source : The Prompt Report — A Systematic Survey of Prompting Techniques, Schulhoff et al., 2024 ([papier complet](../md/prompt-report.md), [arXiv](https://arxiv.org/abs/2406.06608)).
...
Le papier décompose 58 techniques textuelles en 6 grandes catégories (§2.2). In-Context Learning regroupe ici les techniques Few-Shot et Zero-Shot ; les quatre autres familles sont Thought Generation, Decomposition, Ensembling et Self-Criticism.
...
## Voir aussi
- (base prompting IBM) [Catalogue des techniques](../../../ibm-guide-prompt-engineering/concepts/techniques-catalogue.md)
