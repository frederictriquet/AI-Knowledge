...
## Voir aussi
- (IBM) [Optimisation des prompts](../../../ibm-guide-prompt-engineering/concepts/prompt-optimization.md)
- (IBM) [DSPy](../../../ibm-guide-prompt-engineering/concepts/dspy.md)
- (IBM) [Qu'est-ce que le prompt engineering](../../../ibm-guide-prompt-engineering/concepts/prompt-engineering.md)
