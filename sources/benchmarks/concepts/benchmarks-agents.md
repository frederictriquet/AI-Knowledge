...
- (agents IBM) [Évaluation de trajectoire](../../../ibm-guide-agents-ia/concepts/evaluation-trajectoire.md) · (Hamel) [Eval-driven development](../../hamel-husain/concepts/eval-driven-development.md)
