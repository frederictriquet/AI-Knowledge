...
> Fiche du [glossaire prompting](../GLOSSAIRE-PROMPTING.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/12-prevent-prompt-injection.md](../md/12-prevent-prompt-injection.md)
...
## Voir aussi
- [spotlighting](../../ibm-guide-agents-ia/concepts/hors-corpus/spotlighting.md) (base agents, hors-corpus)
- [dual-LLM & CaMeL](../../ibm-guide-agents-ia/concepts/hors-corpus/dual-llm-camel.md) (base agents, hors-corpus)
- [OWASP](../../ibm-guide-agents-ia/concepts/hors-corpus/owasp-llm-agentic.md) (base agents, hors-corpus)
