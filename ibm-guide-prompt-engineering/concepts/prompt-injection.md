...
> Fiche du [glossaire prompting](../GLOSSAIRE-PROMPTING.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/11-prompt-injection.md](../md/11-prompt-injection.md), [../md/13-ai-prompt-injection-nist-report.md](../md/13-ai-prompt-injection-nist-report.md)
...
## Source primaire
Pages IBM citées (think/topics/prompt-injection, think/insights/ai-prompt-injection-nist-report). Rapport NIST *Adversarial Machine Learning* cité nommément. Découverte et nommage attribués à Goodside et Willison ; injection indirecte à Greshake, Abdelnabi, Mishra, Endres, Holz et Fritz (fév. 2023).

## Voir aussi
- [Sécurité agentique](../../ibm-guide-agents-ia/concepts/securite-agentique.md) (base agents)
- [lethal trifecta](../../ibm-guide-agents-ia/concepts/hors-corpus/lethal-trifecta.md) (base agents, hors-corpus)
