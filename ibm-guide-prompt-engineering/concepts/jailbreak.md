...
> Fiche du [glossaire prompting](../GLOSSAIRE-PROMPTING.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/14-ai-jailbreak.md](../md/14-ai-jailbreak.md)
...
## Source primaire
Page IBM citée (think/insights/ai-jailbreak). Statistiques (20 % de réussite, 42 s, 90 % de fuites) référencées par IBM via notes de bas de page non détaillées dans le corpus ; aucun arXiv reproductible.
