...
4. **Points de contact** — `grep` le **nom** ET le **slug** dans : `wiki/fiches outils/<slug>.md`, `wiki/Q1 - …md` / `wiki/Q2 - …md` / `wiki/Q3 - …md`, `wiki/outils IA.md`, `outils candidats.md`, et les **liens croisés** d'autres fiches. La maj doit être **cohérente partout** (fiche + ligne(s) de tableau + ⚠️ si statut sensible), pas seulement dans la fiche.
