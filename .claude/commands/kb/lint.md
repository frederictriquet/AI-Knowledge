...
2. **Index & doublons de titre** : `python3 tools/build_index.py` — ⚠️ **régénère** `INDEX-THEMATIQUE.md` et `RAPPORT-CORPUS.md` (ce n'est pas qu'une lecture) ; lis le rapport généré.
