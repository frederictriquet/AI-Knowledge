...
4. **Fiche** — créer `fiches outils/<slug-kebab>.md` au format de `fiches outils/_TEMPLATE.md` (renseigner `themes: [...]`) ; terminer la section Source par `*(vérifié le AAAA-MM-JJ)*`.
...
7. **Journal** — ajouter une entrée `TOOL` dans `log.md`.
