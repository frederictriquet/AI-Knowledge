...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [../md/30-rewoo.md](../md/30-rewoo.md), [../md/18-agentic-reasoning.md](../md/18-agentic-reasoning.md), [../md/31-build-rewoo-reasoning-agent-granite.md](../md/31-build-rewoo-reasoning-agent-granite.md)
