...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [66-agentic-chunking](../md/66-agentic-chunking.md), [67-use-agentic-chunking-to-optimize-llm-inputs-with-langchain-watsonx-ai](../md/67-use-agentic-chunking-to-optimize-llm-inputs-with-langchain-watsonx-ai.md)
