...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [64-agentic-rag](../md/64-agentic-rag.md), [65-agentic-rag](../md/65-agentic-rag.md)
...
| **Retriever** | Ramener les top-K passages (souvent + un [reranking](hors-corpus/reranking.md)) |
...
- Hors-corpus : [HyDE](hors-corpus/hyde.md) · [GraphRAG](hors-corpus/graphrag.md) · [Reranking](hors-corpus/reranking.md) · [Contextual Retrieval](hors-corpus/contextual-retrieval.md)
