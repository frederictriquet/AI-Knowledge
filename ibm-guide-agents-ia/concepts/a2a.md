...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [35-agent2agent-protocol](../md/35-agent2agent-protocol.md), [36-use-a2a-protocol-for-ai-agent-communication](../md/36-use-a2a-protocol-for-ai-agent-communication.md), [32-ai-agent-protocols](../md/32-ai-agent-protocols.md)
