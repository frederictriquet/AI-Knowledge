...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [21-use-lm-studio-to-build-automatic-tool-calling-granite](../md/21-use-lm-studio-to-build-automatic-tool-calling-granite.md)
...
## Source primaire
« Ce n'est pas beaucoup, mais c'est suffisant pour que le modèle puisse jouer une partie d'échecs complète sans halluciner et utiliser un raisonnement intelligent pour fonder ses décisions. » (IBM, [use-lm-studio…](../md/21-use-lm-studio-to-build-automatic-tool-calling-granite.md))
