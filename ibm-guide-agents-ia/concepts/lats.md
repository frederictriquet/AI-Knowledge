...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/18-agentic-reasoning.md](../md/18-agentic-reasoning.md)
...
Faute de ces conditions, on reste plus bas sur l'échelle de complexité — `1 appel → CoT → Self-Consistency → ReAct → Reflexion → … → LATS`. Dans l'immense majorité des cas, [Self-Consistency](hors-corpus/self-consistency.md) (N essais + vote) ou [Reflexion](reflexion.md) (réessai après critique de l'échec) donnent 80 % du bénéfice pour une fraction de la complexité. LATS est le dernier recours, quand on a vraiment besoin du backtracking sur un arbre persistant.
