...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [68-build-corrective-rag-agent-granite-tavily](../md/68-build-corrective-rag-agent-granite-tavily.md)
...
## Source primaire
« Cette fonction empêche la génération de réponses trompeuses et permet l'autocorrection, ce qui contribue à l'affinement des connaissances. » (IBM, [build-corrective-rag-agent-granite-tavily](../md/68-build-corrective-rag-agent-granite-tavily.md))
