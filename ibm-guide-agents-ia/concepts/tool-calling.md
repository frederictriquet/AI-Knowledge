...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [19-tool-calling](../md/19-tool-calling.md), [20-local-tool-calling-ollama-granite](../md/20-local-tool-calling-ollama-granite.md), [52-using-langchain-tools-to-build-an-ai-agent](../md/52-using-langchain-tools-to-build-an-ai-agent.md)
