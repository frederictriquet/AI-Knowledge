...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [15-ai-agent-memory](../md/15-ai-agent-memory.md), [10-components-of-ai-agents](../md/10-components-of-ai-agents.md)
