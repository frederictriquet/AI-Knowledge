...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [37-model-context-protocol](../md/37-model-context-protocol.md), [38-how-to-build-an-mcp-server](../md/38-how-to-build-an-mcp-server.md), [32-ai-agent-protocols](../md/32-ai-agent-protocols.md), [33-agent-communication-protocol](../md/33-agent-communication-protocol.md)
