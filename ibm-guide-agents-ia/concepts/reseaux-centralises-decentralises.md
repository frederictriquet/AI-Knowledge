...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [25-multiagent-system](../md/25-multiagent-system.md), [23-ai-agent-orchestration](../md/23-ai-agent-orchestration.md), [13-ai-agent-communication](../md/13-ai-agent-communication.md)
