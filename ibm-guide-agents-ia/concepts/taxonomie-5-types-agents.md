...
> Fiche du [glossaire des patterns](../GLOSSAIRE-PATTERNS.md) · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [08-ai-agent-types](../md/08-ai-agent-types.md), [09-simple-reflex-agent](../md/09-simple-reflex-agent.md), [69-ai-agent-use-cases](../md/69-ai-agent-use-cases.md)
