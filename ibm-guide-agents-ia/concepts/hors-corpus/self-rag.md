...
Réduit hallucinations et sur-récupération. Exige un modèle entraîné/fine-tuné à émettre ces tokens (≠ simple prompt). Même objectif que le Corrective RAG (cRAG) du corpus, mais obtenu par **apprentissage** plutôt que par un grader externe : Self-RAG = la qualité dans les poids, cRAG = la qualité dans le pipeline.
...
## Voir aussi
- [corrective-rag](../corrective-rag.md) (corpus)
