...
> Fiche du glossaire des patterns · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [22-agentic-architecture](../sources/ibm-guide-agents-ia/md/22-agentic-architecture.md)
...
## Source primaire
Non citée spécifiquement pour cette tripartition — vocabulaire classique de l'IA des agents (Wooldridge, Brooks pour le réactif). Le fichier 22 cite par ailleurs Bandura (doi:10.1146/annurev.psych.52.1.1) et Masterman et al. (arXiv:2404.11584) sur d'autres points.
