...
## Source primaire
Non rattaché à une source nommée ; présenté comme application de la mémoire épisodique décrite dans CoALA (Princeton, 2024). Le case-based reasoning comme discipline est antérieur.
