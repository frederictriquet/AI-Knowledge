...
## Source primaire
Source : think/topics/prompt-tuning et tutorials/prompt-tune-a-granite-model. L'analyse formelle de la limite expressive et les chiffres PEFT (P-tuning v2, LoRA, adaptateurs) sont référencés via des notes de bas de page non explicitées dans la source — aucun arXiv reproductible ici.
