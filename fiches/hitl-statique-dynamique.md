...
> Fiche du glossaire des patterns · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [63-human-in-the-loop-ai-agent-langraph-watsonx-ai](../sources/ibm-guide-agents-ia/md/63-human-in-the-loop-ai-agent-langraph-watsonx-ai.md)
...
## Source primaire
Non citée par IBM — mécanismes du framework LangGraph (`interrupt_before`/`interrupt_after`, `interrupt()`, `Command(resume=)`), documentés par LangGraph (hors-corpus).
