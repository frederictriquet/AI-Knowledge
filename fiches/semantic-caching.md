...
## Source primaire
« Les systèmes de RAG agentique utilisent la mise en cache sémantique pour stocker les ensembles de requêtes, le contexte et les résultats précédents et s'y référer. » (IBM, [agentic-rag](../sources/ibm-guide-agents-ia/md/64-agentic-rag.md))
