...
Weng relie quatre techniques (ReAct, Reflexion, CoH, AD) en une même lignée « apprendre de ses erreurs » et en explicite les mécanismes internes (heuristique, récompense binaire, fine-tuning sur historique).
