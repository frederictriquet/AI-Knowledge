...
Anthropic fournit le **critère de décision** explicite et l'avertissement anti-hype : beaucoup d'applications n'ont pas besoin d'un agent, et la distinction workflow/agent évite de sur-complexifier par défaut.
