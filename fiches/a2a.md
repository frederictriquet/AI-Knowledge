...
> Fiche du glossaire des patterns · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [35-agent2agent-protocol](../sources/ibm-guide-agents-ia/md/35-agent2agent-protocol.md), [36-use-a2a-protocol-for-ai-agent-communication](../sources/ibm-guide-agents-ia/md/36-use-a2a-protocol-for-ai-agent-communication.md), [32-ai-agent-protocols](../sources/ibm-guide-agents-ia/md/32-ai-agent-protocols.md)
...
## Source primaire
Citée par IBM : lancé par Google (avril 2025), Linux Foundation, site officiel a2aproject.github.io/A2A/ et exemples github.com/a2aproject/a2a-samples.
