...
> Fiche du glossaire prompting · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [../md/19-implement-prompt-caching-langchain.md](../sources/ibm-guide-prompt-engineering/md/19-implement-prompt-caching-langchain.md)
...
## Voir aussi
- [Semantic caching](semantic-caching.md) (base agents)
