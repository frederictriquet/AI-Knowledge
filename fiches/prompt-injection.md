...
> Fiche du glossaire prompting · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/11-prompt-injection.md](../sources/ibm-guide-prompt-engineering/md/11-prompt-injection.md), [../md/13-ai-prompt-injection-nist-report.md](../sources/ibm-guide-prompt-engineering/md/13-ai-prompt-injection-nist-report.md)
...
## Voir aussi
- [Sécurité agentique](securite-agentique.md) (base agents)
- [lethal trifecta](lethal-trifecta.md) (base agents, hors-corpus)
