...
> Fiche du glossaire des patterns · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [66-agentic-chunking](../sources/ibm-guide-agents-ia/md/66-agentic-chunking.md), [67-use-agentic-chunking-to-optimize-llm-inputs-with-langchain-watsonx-ai](../sources/ibm-guide-agents-ia/md/67-use-agentic-chunking-to-optimize-llm-inputs-with-langchain-watsonx-ai.md)
