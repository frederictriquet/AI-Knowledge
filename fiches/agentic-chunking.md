...
## Source primaire
Le chunking sémantique, dont le chunking agentique s'inspire, est attribué à Greg Kamradt (GitHub). Le chunking agentique lui-même n'est rattaché à aucun auteur précis dans la littérature de référence.
