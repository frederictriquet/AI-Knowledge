...
> Fiche du glossaire prompting · Pertinence 🔴 substance · Provenance ✅ présent · Sources corpus : [../md/21-directional-stimulus-prompting.md](../sources/ibm-guide-prompt-engineering/md/21-directional-stimulus-prompting.md)
...
- (base agents) [tool grounding](tool-grounding.md)
