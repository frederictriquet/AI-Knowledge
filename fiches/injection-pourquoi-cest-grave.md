...
> Fiche **source : Simon Willison** · [post complet](../sources/simon-willison/md/worst-that-can-happen.md) · Pertinence 🔴 substance
...
- (Prompt Report) [Taxonomie du prompt hacking](prompt-hacking-taxonomie.md)
- [post complet](../sources/simon-willison/md/worst-that-can-happen.md)
- (complément — *payloads exacts & PoC*) [Rehberger — AI injections basics](ai-injections-basics.md)
