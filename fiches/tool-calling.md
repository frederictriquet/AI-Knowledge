...
## Source primaire
« L'appel d'outil, parfois appelé appel de fonction, est un catalyseur clé de l'IA agentique. » (IBM, [tool-calling](../sources/ibm-guide-agents-ia/md/19-tool-calling.md))
