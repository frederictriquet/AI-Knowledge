...
## Source primaire
« Les cadres d'agents de planification et d'exécution sont une évolution des agents ReAct. Ils peuvent exécuter des workflows en plusieurs étapes sans rappeler l'agent principal. » (IBM, [agentic-rag](../sources/ibm-guide-agents-ia/md/64-agentic-rag.md))
