...
> Fiche **source : Lilian Weng** · [post complet](../sources/lilian-weng/md/2023-10-25-adv-attack-llm.md) · Pertinence 🔴 substance
...
## Voir aussi
- (base prompting) [Jailbreak](jailbreak.md) · [Injection de prompt](prompt-injection.md)
- (base agents) [Sécurité agentique](securite-agentique.md)
