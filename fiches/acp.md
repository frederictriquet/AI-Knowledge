...
> Fiche du glossaire des patterns · Pertinence 🟡 tradeoff · Provenance ✅ présent · Sources corpus : [33-agent-communication-protocol](../sources/ibm-guide-agents-ia/md/33-agent-communication-protocol.md), [34-acp-ai-agent-interoperability-building-multi-agent-workflows](../sources/ibm-guide-agents-ia/md/34-acp-ai-agent-interoperability-building-multi-agent-workflows.md), [32-ai-agent-protocols](../sources/ibm-guide-agents-ia/md/32-ai-agent-protocols.md)
