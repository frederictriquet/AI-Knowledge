...
> Fiche du glossaire des patterns · Pertinence 🟢 pur-nom · Provenance ✅ présent · Sources corpus : [../md/18-agentic-reasoning.md](../sources/ibm-guide-agents-ia/md/18-agentic-reasoning.md), [../md/28-react-agent.md](../sources/ibm-guide-agents-ia/md/28-react-agent.md), [../md/17-ai-agent-planning.md](../sources/ibm-guide-agents-ia/md/17-ai-agent-planning.md)
