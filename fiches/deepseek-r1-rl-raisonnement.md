...
> Fiche **source : DeepSeek-AI, « DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning », 2025** · [papier](../sources/frontier-reasoning/md/deepseek-r1.md) · Pertinence 🔴 substance
...
- (agents IBM hors-corpus) [Modèles de raisonnement](inference-time-scaling.md)
