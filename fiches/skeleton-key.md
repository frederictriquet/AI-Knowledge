...
## Source primaire
Source : think/insights/llm-skeleton-key. Citations directes de Chenta Lee (IBM, architecte en chef renseignement sur les menaces), Stephen Kowski (SlashNext) et Narayana Pappu (Zendata). Technique Skeleton Key attribuée à Microsoft ; pas de référence académique formelle.
