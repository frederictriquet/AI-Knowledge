...
2026-06-24  TOOL  ECC (affaan-m/ECC) ajouté en Q1 fam.4 (workflow/méthodologie), themes [frameworks-outillage, gouvernance-alignement-ops, securite, efficacite-cout]. « Operator system » de harness multi-plateforme (MIT, 🔓🎁🔁 ; ECC Pro 19 $/siège/mois). Coût LLM 🟢🔑 : cœur dans le harness hôte sans clé, BYOK multi-provider (Anthropic/OpenAI/Ollama local) pour AgentShield/security-scan & autonomous-harness (vérifié dans `src/llm/providers/` + `.cursor/hooks/`). Fiche délibérément critique : créé 2026-01-18 (jeune) malgré discours « production »/« 10+ months » ; maximaliste (261 skills/67 agents) en tension avec sa propre règle « <10 MCP/<80 outils » ; mono-mainteneur ; 220,8k★ en 5 mois = hype ≠ valeur prouvée ; métriques internes auto-déclarées. Peers focalisés (Superpowers, Spec Kit) souvent préférables.
