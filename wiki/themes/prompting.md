...
- **[ICL: exemplar selection & zero-shot techniques](../concepts/icl-exemplar-et-zero-shot.md)** — In few-shot, the choice of examples, their order and their quantity matter as much as the prompt content; in zero-shot, several simple rephrasings of the instruction are enough to improve the output.
