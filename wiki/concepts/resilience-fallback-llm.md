...
- **Model/provider fallback**: if OpenAI returns 429, switch to Anthropic (or an equivalent model) rather than failing. This is precisely what gateways ([OpenRouter](../../fiches%20outils/openrouter.md), [LiteLLM](../../fiches%20outils/litellm.md), [Portkey](../../fiches%20outils/portkey.md)) sell under the name failover chains.
