...
**Exact count (5 or 6?).** The text of §2.2 announces "58 text-based prompting techniques, broken into 6 major categories (Figure 2.2)", and Figure 2.2 does show six head boxes: Zero-Shot, Few-Shot, Thought Generation, Ensembling, Self-Criticism, Decomposition. **But** the report's numbered-section breakdown counts only **5 families**: Zero-Shot and Few-Shot are grouped under **In-Context Learning (ICL)** (§2.2.1, with Few-Shot in §2.2.1.2 and Zero-Shot in §2.2.1.3), the other four being Thought Generation (§2.2.2), Decomposition (§2.2.3), Ensembling (§2.2.4) and Self-Criticism (§2.2.5). This note adopts the section count: **5 families, Zero-Shot and Few-Shot filed under ICL** (the "6" of the figure comes from their visual separation). A technique that can belong to several families is placed in the category "of most relevance". The authors also note that the term "learn" in ICL is misleading: it can be a simple task specification.
