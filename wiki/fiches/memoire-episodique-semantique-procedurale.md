...
## Exemple
La source ancre chaque type sur un cas. Épisodique : un conseiller financier alimenté par l'IA se souvient des choix d'investissement passés d'un utilisateur et s'appuie sur cet historique pour de meilleures recommandations. Sémantique : un assistant juridique interroge sa base de connaissances pour retrouver des précédents et fournir des conseils précis. Procédurale : analogie de l'humain qui fait du vélo ou écrit au clavier sans réfléchir à chaque étape — l'agent automatise des séquences d'actions apprises, souvent par apprentissage par renforcement.
