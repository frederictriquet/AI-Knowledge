...
## Source primaire
Implémentation watsonx avec le modèle Granite Guardian (`ibm_watsonx_ai.foundation_models.moderations.Guardian`), détecteurs HAP et PII.
