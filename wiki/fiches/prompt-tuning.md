...
## Exemple
Analyse de sentiment sur un modèle de 175 Md gelé : on initialise 20 tokens virtuels, vecteurs vivant dans le même espace de 12 288 dimensions que le vocabulaire. L'entrée « The movie was absolutely fantastic! » devient en interne `[<v1>, <v2>, ... <v20>, The, movie, was, absolutely, fantastic, !]`. La rétropropagation ne met à jour que ces 20 vecteurs (quelques milliers de paramètres), jamais les 175 Md de poids. Pour passer à la détection de spam, on entraîne un nouveau fichier de soft prompts et on le permute à l'inférence — sans dupliquer le modèle.
