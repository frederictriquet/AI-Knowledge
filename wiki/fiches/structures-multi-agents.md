...
## Exemple
Gestion de la chaîne d'approvisionnement : des agents conversationnels aux objectifs parfois contradictoires (acheteur, fournisseur, logistique) doivent négocier entre eux — typiquement une coalition opportuniste, formée le temps de fluidifier un flux puis dissoute. En face, la défense maritime relève de la structure équipe : des agents fortement interdépendants et hiérarchisés collaborent en continu pour identifier les interactions entre navires hostiles et navires de défense, sans jamais agir isolément. Le holon, lui, se vit comme le corps humain : un agent-organe inséparable du tout qu'il sert.
