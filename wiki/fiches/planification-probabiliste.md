...
## Exemple
Reprenons le robot de navigation décrit dans la même source, dont l'état inclut coordonnées, obstacles et conditions du terrain. En déterministe, une recherche heuristique suffit. Mais si le terrain est glissant ou un obstacle mobile, le résultat d'un déplacement n'est plus certain : la planification probabiliste évalue plusieurs issues possibles de chaque action et retient celle dont l'utilité attendue est la plus élevée. En multi-agents, le cadre MDP/bayésien laisse chaque agent mettre à jour ses croyances et prédire les résultats sans visibilité complète sur les autres.
