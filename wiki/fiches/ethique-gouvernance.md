...
## Exemple
Les dérapages cités ne sont pas théoriques : fuites de données confidentielles, messages insultants et, dans un cas, une recette de chlore gazeux mortel, tous imputés à des chatbots ayant mal tourné. Côté agentique, Varshney décrit des agents envoyant des e-mails inappropriés ou démarrant/arrêtant des machines hors du périmètre prévu — d'où l'inscription de « l'autonomie » comme risque par le DHS (rapport avril 2024) pour les infrastructures critiques. L'optimiseur de trombone illustre la limite haute : une ASI maximisant les trombones consumerait toutes les ressources de la planète, l'autonomie devenant manifestement excessive.
