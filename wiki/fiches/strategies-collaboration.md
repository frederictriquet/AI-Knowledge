...
## Exemple
Système de santé intelligent en collaboration basée sur les rôles : un agent surveille les signaux physiologiques, un autre identifie les anomalies, un troisième recommande des traitements, un dernier gère les données patient en conformité réglementaire — chacun a permissions et objectifs propres, mais partage l'information pour assurer continuité et tolérance aux pannes. La source illustre aussi le mode émergent par une flotte de drones explorant une zone sinistrée : chaque drone suit son itinéraire, évite les autres, rapporte ses découvertes et change de cap sur événement imprévu, sans chef unique.
