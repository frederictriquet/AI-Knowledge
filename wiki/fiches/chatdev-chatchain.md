...
## Exemple
ChatDev positionne ses LLM comme agents jouant des rôles sociaux explicites — PDG, directeur technique, ingénieur logiciel, concepteur, testeur — qui se prompttent mutuellement par « incitation d'inception ». Sur la déshallucination : face à une instruction floue, plutôt que d'halluciner, l'assistant joue l'instructeur et réclame le nom précis d'une dépendance externe ou le dépôt GitHub exact à modifier ; il n'optimise sa réponse qu'après que l'instructeur a répondu. Une évaluation contre GPT-Engineer (mono-agent) et MetaGPT le départage sur exhaustivité, exécutabilité, cohérence et qualité : ChatDev surpasse nettement MetaGPT sur la qualité grâce à la communication mêlant langage naturel et code.
