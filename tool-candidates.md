...
> ✅ *Famille traitée le 2026-06-16 — 7 fiches créées et ajoutées à [IA dans un produit](guides/ai-in-production.md), famille 1 (aux côtés de Chroma).*
...
> ✅ *6 fiches créées le 2026-06-16 et ajoutées à [IA dans un produit](guides/ai-in-production.md), famille 2 (aux côtés de CrewAI). Restent à arbitrer : Google ADK, Agno, smolagents, Strands.*
...
- [x] **12. Évaluation / observabilité LLM** — Langfuse, LangSmith, Braintrust, Helicone, Arize Phoenix ✅ *ajoutée dans [IA dans un produit](guides/ai-in-production.md), famille 8 (LLMOps)*
- [x] **13. Passerelles / routeurs LLM** — **OpenRouter**, **LiteLLM**, **Portkey**, **Requesty** ✅ *ajoutée dans [IA dans un produit](guides/ai-in-production.md), famille 9 (vérifié le 2026-06-16)*
